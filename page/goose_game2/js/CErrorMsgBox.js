function CErrorMsgBox(szText, oParentContainer) {
    ...
    this._init = function(szText) {
        ...
        _oMsg = new CTLText(_oContainer, CANVAS_WIDTH_HALF - 250, CANVAS_HEIGHT_HALF - 150, 500, 160, 20, "center", "#fff", PRIMARY_FONT, 1.1, 0, 0, TEXT_ERR_LS, true, true, true, false);
