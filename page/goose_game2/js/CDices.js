function CDices() {
    ...
    this._init = function() {
        ...
        var oData = {
            images: [s_oSpriteLibrary.getSprite("dice_a_1"), s_oSpriteLibrary.getSprite("dice_a_2"), s_oSpriteLibrary.getSprite("dice_a_3"), s_oSpriteLibrary.getSprite("dice_a_4"), s_oSpriteLibrary.getSprite("dice_a_5"), s_oSpriteLibrary.getSprite("dice_a_6")],
            framerate: 24,
            frames: {
                width: 318,
                height: 224,
        ...
        var oData = {
            images: [s_oSpriteLibrary.getSprite("dice_b_1"), s_oSpriteLibrary.getSprite("dice_b_2"), s_oSpriteLibrary.getSprite("dice_b_3"), s_oSpriteLibrary.getSprite("dice_b_4"), s_oSpriteLibrary.getSprite("dice_b_5"), s_oSpriteLibrary.getSprite("dice_b_6")],
            framerate: 30,
            frames: {
                width: 384,
                height: 320,
    ...
    this.fadeOutTween = function() {
        createjs.Tween.get(_oDice1, {
            loop: false
        }).to({
            alpha: 0
        }, 200);
        createjs.Tween.get(_oDice2, {
            loop: false
        }).to({
            alpha: 0
        }, 200).call(this.hide);
