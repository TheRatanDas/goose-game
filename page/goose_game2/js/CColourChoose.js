function CColourChoose(iPlayers, iMode) {
    ...
    this._init = function() {
        ...
        _oSelectColourTextStroke = new CTLText(_oContTextSelectColour, -250, 40, 500, 40, 40, "center", SECONDARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_SELECT_COLOUR, true, true, true, false);
        _oSelectColourTextStroke.setOutline(5);
        _oSelectColourText = new CTLText(_oContTextSelectColour, -250, 40, 500, 40, 40, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_SELECT_COLOUR, true, true, true, false);
