function CPreloader() {
    ...
    this._init = function() {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./page/goose_game2/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./page/goose_game2/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./page/goose_game2/sprites/but_start.png");
