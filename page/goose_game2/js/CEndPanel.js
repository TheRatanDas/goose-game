function CEndPanel(oSpriteBg) {
    ...
    this._init = function(oSpriteBg) {
        ...
        _oTitleTextStroke = new CTLText(_oGroup, CANVAS_WIDTH_HALF - 250, 180, 500, 40, 40, "center", SECONDARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_WIN, true, true, true, false);
        _oTitleTextStroke.setOutline(5);
        _oTitleText = new CTLText(_oGroup, CANVAS_WIDTH_HALF - 250, 180, 500, 40, 40, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_WIN, true, true, true, false);
        _oRecordText1Stroke = new CTLText(_oGroup, CANVAS_WIDTH_HALF - 250, 240, 500, 20, 20, "center", SECONDARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_GAMES_PLAYED + ": " + s_aGamesPlayed, true, true, true, false);
        _oRecordText1Stroke.setOutline(3);
        _oRecordText1 = new CTLText(_oGroup, CANVAS_WIDTH_HALF - 250, 240, 500, 20, 20, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_GAMES_PLAYED + ": " + s_aGamesPlayed, true, true, true, false);
        _oRecordText2Stroke = new CTLText(_oGroup, CANVAS_WIDTH_HALF - 250, 270, 500, 20, 20, "center", SECONDARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_GAMES_WON + ": " + s_aGamesWon, true, true, true, false);
        _oRecordText2Stroke.setOutline(3);
        _oRecordText2 = new CTLText(_oGroup, CANVAS_WIDTH_HALF - 250, 270, 500, 20, 20, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_GAMES_WON + ": " + s_aGamesWon, true, true, true, false);
