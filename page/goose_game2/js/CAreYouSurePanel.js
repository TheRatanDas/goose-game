function CAreYouSurePanel() {
    ...
    this._init = function() {
        ...
        var oTitleBack = new CTLText(_oPanelContainer, CANVAS_WIDTH / 2 - 200, CANVAS_HEIGHT_HALF - 130, 400, 100, 50, "center", SECONDARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_ARE_SURE, true, true, true, false);
        oTitleBack.setOutline(5);
        var oTitle = new CTLText(_oPanelContainer, CANVAS_WIDTH / 2 - 200, CANVAS_HEIGHT_HALF - 130, 400, 100, 50, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_ARE_SURE, true, true, true, false);
