function CMenu() {
    ...
    this._init = function() {
        ...
        new createjs.Tween.get(_oMenuLogo).to({
    ...
    this.createPlayer = function() {
        ...
        new createjs.Tween.get(_oPlayerShadow).to({
            x: CANVAS_WIDTH + 50
        }, 5000);
        new createjs.Tween.get(_oPlayer, {
            loop: true
        }).to({
            y: _pStartPosPlayers.y - 20
        }, 150, createjs.Ease.quadIn).to({
            y: _pStartPosPlayers.y
        }, 150, createjs.Ease.quadIn);
        new createjs.Tween.get(_oPlayer).to({
            x: CANVAS_WIDTH + 50
        }, 5000).call(function() {
