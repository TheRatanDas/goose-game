function CModeSelection() {
    ...
    this._init = function() {
        ...
        var oSelectModeTextStroke = new CTLText(_oContTextSelect, -250, 40, 500, 40, 40, "center", SECONDARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_SELECT_OPPONENTS, true, true, true, false);
        oSelectModeTextStroke.setOutline(5);
        var oSelectModeText = new CTLText(_oContTextSelect, -250, 40, 500, 40, 40, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_SELECT_OPPONENTS, true, true, true, false);
        var iOffsetX = 120;
