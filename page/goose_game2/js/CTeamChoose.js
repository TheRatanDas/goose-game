function CTeamChoose(iMode) {
    ...
    this._init = function() {
        ...
        var oSelectTeamTextStroke = new CTLText(_oContTextSelectTeam, -250, 40, 500, 40, 40, "center", SECONDARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_SELECT_PLAYERS, true, true, true, false);
        oSelectTeamTextStroke.setOutline(5);
        var oSelectTeamText = new CTLText(_oContTextSelectTeam, -250, 40, 500, 40, 40, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1.1, 0, 0, TEXT_SELECT_PLAYERS, true, true, true, false);
